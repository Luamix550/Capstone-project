...
// FeedbackCard component to display individual feedback details
const FeedbackCard = ({ feedback }) => (
  <div
    className={`rounded-xl p-6 border sm:shadow-inner border-black bg-white 
      min-w-[100%] sm:min-w-[400px] md:min-w-[640px] lg:min-w-[300px] 
      max-w-[100%] sm:max-w-[400px] md:max-w-[640px] lg:max-w-[800px] 
      h-auto overflow-auto hover:scale-95 transition duration-300`}
    role="button"
    style={{ scrollSnapAlign: 'start' }}
  >
    <div className="flex flex-col justify-between h-full">
      <div>
        {/* Header with rating and category image */}
        <div className="flex justify-between items-center">
          <HalfRating name="read-only" value={feedback.current_rating} readOnly />
          {/* Display category image based on feedback category */}
      ...
      {/* Status section with conditional styling based on feedback status */}
      <div
        className={`flex mt-4 p-6 rounded-lg w-full ${
